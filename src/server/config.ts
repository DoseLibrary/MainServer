...
type TuningKey = 'SCAN_FS_CONCURRENCY' | 'SCAN_INGEST_CONCURRENCY' | 'SCAN_STALE_AFTER_MS' | 'LIBRARY_WATCH_ENABLED' | 'LIBRARY_WATCH_DEBOUNCE_MS' | 'FFPROBE_CONCURRENCY' | 'FFPROBE_TIMEOUT_MS' | 'TMDB_CONCURRENCY' | 'TMDB_REQUESTS_PER_SECOND' | 'TMDB_TIMEOUT_MS';
